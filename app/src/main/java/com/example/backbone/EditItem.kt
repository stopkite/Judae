...
data class EditloadQuestionData(
        override var id: Any, var QuestionID: String, var qTitle: String?, var aImg: Bitmap?,
...
data class EditloadContentData(override var id: Int, var contentID: Int, var contentImg: Bitmap?,
                               var linkInsertTxt: EditText?, var linkInsertBtn:Button?,
                               var linkLayout: View?, var linkTitle:String?, var linkContent:String?, var linkUri:String?, var linkIcon: Bitmap?,
                               var docContent: String?, var qImgAddBtn:ImageButton?, var qLinkAddBtn:ImageButton?, var loadData: Boolean?):EditItem
